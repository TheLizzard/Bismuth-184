...
curr.editor.set_default("cursor_room", 3)
curr.editor.set_default("blockcursor", False)
curr.editor.set_default("padx", (3,3))
curr.editor.set_default("xscroll_speed", 20)
curr.editor.set_default("yscroll_speed", 35)
